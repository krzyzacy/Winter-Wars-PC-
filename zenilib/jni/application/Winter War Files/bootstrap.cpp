...
class Title_State_Custom : public Title_State<Team_Select_State, Instructions_State, Credits_State>{
	...
	public:
		...
		void render() {
			...
			Title_State<Team_Select_State, Instructions_State, Credits_State>::render();
