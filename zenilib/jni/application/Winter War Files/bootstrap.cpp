...
private:
  ...
  void render() {
	...
	get_Fonts()["system_36_800x600"].render_text("A for local game" ,Point2f(155, 260), Color(0xFF33BBE8));
	get_Fonts()["system_36_800x600"].render_text("B for network game" ,Point2f(155, 460), Color(0xFF33BBE8));
	//get_Video().set_2d(make_pair(Point2f(0.0f, 0.0f), Point2f(1920.0f, 1200.0f)), true);
