...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/local_freetype2
  TARGETDIR  = ../../lib/d32
  TARGET     = $(TARGETDIR)/liblocal_freetype2_d.so
  DEFINES   += -D_LINUX -D_DEBUG -DDEBUG -DTEST_NASTY_CONDITIONS -DDISABLE_CPP11 -DGLEW_NO_GLU -DDISABLE_CG -DOGG_DLL= -DVORBIS_DLL= -DVORBISFILE_DLL= -DDISABLE_DX9 -DDISABLE_WGL -DTINYXML_DLL= -DTINYXML_EXT= -DZENI_DLL= -DZENI_EXT= -DZENI_AUDIO_DLL= -DZENI_AUDIO_EXT= -DZENI_CORE_DLL= -DZENI_CORE_EXT= -DZENI_GRAPHICS_DLL= -DZENI_GRAPHICS_EXT= -DZENI_NET_DLL= -DZENI_NET_EXT= -DZENI_REST_DLL= -DZENI_REST_EXT= -DBUILD_FREETYPE2_DLL -D_LIB -DFT2_BUILD_LIBRARY=1
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/local_freetype2
  TARGETDIR  = ../../lib/x32
  TARGET     = $(TARGETDIR)/liblocal_freetype2.so
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/local_freetype2
  TARGETDIR  = ../../lib/d64
  TARGET     = $(TARGETDIR)/liblocal_freetype2_d.so
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/local_freetype2
  TARGETDIR  = ../../lib/x64
  TARGET     = $(TARGETDIR)/liblocal_freetype2.so
