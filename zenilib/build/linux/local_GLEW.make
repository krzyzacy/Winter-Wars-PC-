...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/local_GLEW
  TARGETDIR  = ../../lib/d32
  TARGET     = $(TARGETDIR)/liblocal_GLEW_d.so
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/local_GLEW
  TARGETDIR  = ../../lib/x32
  TARGET     = $(TARGETDIR)/liblocal_GLEW.so
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/local_GLEW
  TARGETDIR  = ../../lib/d64
  TARGET     = $(TARGETDIR)/liblocal_GLEW_d.so
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/local_GLEW
  TARGETDIR  = ../../lib/x64
  TARGET     = $(TARGETDIR)/liblocal_GLEW.so
