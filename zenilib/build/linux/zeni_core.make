...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/zeni_core
  TARGETDIR  = ../../lib/d32
  TARGET     = $(TARGETDIR)/libzeni_core_d.so
  ...
  LDDEPS    += ../../lib/d32/libzeni_d.so ../../lib/d32/liblocal_SDL_d.so
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/zeni_core
  TARGETDIR  = ../../lib/x32
  TARGET     = $(TARGETDIR)/libzeni_core.so
  ...
  LDDEPS    += ../../lib/x32/libzeni.so ../../lib/x32/liblocal_SDL.so
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/zeni_core
  TARGETDIR  = ../../lib/d64
  TARGET     = $(TARGETDIR)/libzeni_core_d.so
  ...
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -lzeni_d -llocal_SDL_d
  LDDEPS    += ../../lib/d64/libzeni_d.so ../../lib/d64/liblocal_SDL_d.so
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/zeni_core
  TARGETDIR  = ../../lib/x64
  TARGET     = $(TARGETDIR)/libzeni_core.so
  ...
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LIBS      += -lzeni -llocal_SDL
  LDDEPS    += ../../lib/x64/libzeni.so ../../lib/x64/liblocal_SDL.so
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(LIBS) $(LDFLAGS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
