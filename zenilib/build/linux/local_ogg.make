...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/local_ogg
  TARGETDIR  = ../../lib/d32
  TARGET     = $(TARGETDIR)/liblocal_ogg_d.so
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/local_ogg
  TARGETDIR  = ../../lib/x32
  TARGET     = $(TARGETDIR)/liblocal_ogg.so
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/local_ogg
  TARGETDIR  = ../../lib/d64
  TARGET     = $(TARGETDIR)/liblocal_ogg_d.so
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/local_ogg
  TARGETDIR  = ../../lib/x64
  TARGET     = $(TARGETDIR)/liblocal_ogg.so
